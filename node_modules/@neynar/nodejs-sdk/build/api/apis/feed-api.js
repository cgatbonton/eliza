...
const FeedApiAxiosParamCreator = function (configuration) {
    return {
         ...
         *
         */
        fetchFeedByChannelIds: async (channelIds, withRecasts, viewerFid, withReplies, membersOnly, fids, limit, cursor, shouldModerate, options = {}) => {
...
const FeedApiFp = function (configuration) {
    ...
    return {
         ...
         *
         */
        async fetchFeedByChannelIds(channelIds, withRecasts, viewerFid, withReplies, membersOnly, fids, limit, cursor, shouldModerate, options) {
            var _a, _b, _c;
