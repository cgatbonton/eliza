...
const FrameApiAxiosParamCreator = function (configuration) {
    return {
         ...
         *
         */
        fetchNotificationTokens: async (limit, fids, options = {}) => {
...
const FrameApiFp = function (configuration) {
    ...
    return {
         ...
         *
         */
        async fetchNotificationTokens(limit, fids, options) {
            var _a, _b, _c;
...
class FrameApi extends base_1.BaseAPI {
     ...
     */
    fetchNotificationTokens(requestParameters = {}, options) {
        return (0, exports.FrameApiFp)(this.configuration).fetchNotificationTokens(requestParameters.limit, requestParameters.fids, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch analytics for total-interactors, interactors, nteractions-per-cast and input-text.
     * @summary Analytics for the frame
