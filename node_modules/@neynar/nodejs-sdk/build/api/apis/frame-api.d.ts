...
export declare const FrameApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    fetchNotificationTokens: (limit?: number, fids?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const FrameApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    fetchNotificationTokens(limit?: number, fids?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FrameNotificationTokens>>;
    /**
     * Fetch analytics for total-interactors, interactors, nteractions-per-cast and input-text.
     * @summary Analytics for the frame
     * @param {string} frameUrl
