...
declare namespace config {
    export var put: <T>(key: string, value: T) => {
        put: any;
        get: <T_1>(key: string, fallback?: T_1) => Promise<T_1>;
        all: () => Promise<Record<string, unknown>>;
        first: <T_1>(wants: string[] | undefined, fallback: T_1) => Promise<T_1>;
        update: <T_1>(key: string, fn?: (x: T_1) => T_1) => any;
        delete: typeof _delete;
        ...
        overload: <T_1>(values: Record<string, unknown>, callback: (oldConfig: Record<string, unknown>) => T_1) => Promise<T_1>;
        load: (data: {
            flowJSON: Record<string, unknown> | Record<string, unknown>[];
        }, { ignoreConflicts, }?: {
            ignoreConflicts?: boolean;
    ...
    export var get: <T>(key: string, fallback?: T) => Promise<T>;
